...
namespace VirtueSky.ObjectPooling
{
    internal sealed class PoolHandle
    {
        ...
        internal T Spawn<T>(T type, Transform parent = null, bool worldPositionStays = true)
            where T : Component
        {
            return Spawn(type.gameObject, parent, worldPositionStays).GetComponent<T>();
        }
        ...
        internal T Spawn<T>(T type, Vector3 position, Quaternion rotation, Transform parent = null,
            ...
            where T : Component
        {
            return Spawn(type.gameObject, position, rotation, parent, worldPositionStays).GetComponent<T>();
        }
